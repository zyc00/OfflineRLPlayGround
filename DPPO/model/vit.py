"""
ViT image encoder. Ported from https://github.com/irom-princeton/dppo
(originally from https://github.com/hengyuan-hu/ibrl)
"""
    ...
    def __init__(
        ...
        if embed_style == "embed1":
            self.patch_embed = PatchEmbed1(
                embed_dim, num_channel=num_channel, img_h=img_h, img_w=img_w,
            )
            ...
            raise ValueError(f"Unknown embed_style: {embed_style}")
...
class VitEncoder(nn.Module):
    ...
    def forward(self, obs, flatten=False):
        obs = obs / 255.0 - 0.5
...
def _named_apply(fn, module, name="", depth_first=True, include_root=False):
    ...
    for child_name, child_module in module.named_children():
        ...
        _named_apply(fn, child_module, child_name, depth_first, include_root=True)
